...
def run_multihead_self_attention(
    ...
    """
    MHSA = MultiHeadSelfAttention(d_model, num_heads, max_seq_len=1024)
    MHSA.load_state_dict({"q_proj.weight": q_proj_weight,
...
def run_rope(
    ...
    """
    rope = RopeEmbeddings(theta=theta, d_k=d_k, max_seq_len=max_seq_len)
...
def run_transformer_block(
    ...
    """
    block = TransformerBlock(d_model=d_model, d_ff=d_ff, num_heads=num_heads, max_seq_len=max_seq_len,
                             theta=theta)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    vocab, merges = bpe.train_bpe(input_path)
    return vocab, merges
